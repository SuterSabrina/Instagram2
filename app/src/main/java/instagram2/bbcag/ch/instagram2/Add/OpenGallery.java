...
public class OpenGallery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(OpenGallery.this);
    ...
    public void UploadImageFileToFirebaseStorage() {
        ...
        if (FilePathUri != null) {
            ...
            storageReference2nd.putFile(FilePathUri)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(OpenGallery.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(OpenGallery.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
